...
const userData = {
  name: "Reg", position: "Big Ballin Shotcaller", aboutMe: "dinosaur", skills: ["git", "react", "JSON's"],
...
export default class Profilehandler extends Component {
  state = {
    userData: {
      name: "Reg", position: "Big Ballin Shotcaller", aboutMe: "dinosaur",
  ...
  componentDidMount() {
    ...
    storageRef.child('DanielSmiley.jpg')
